...
TEST(BoundaryValue, Normal)
{
		...
		EXPECT_EQ("ISOSCELES", IsTriangle(200, 100, 100));
		...
		EXPECT_EQ("ISOSCELES", IsTriangle(100, 200, 100));
		...
		EXPECT_EQ("ISOSCELES", IsTriangle(100, 100, 200));
		EXPECT_EQ("ISOSCELES", IsTriangle(100, 100, 100));
}
